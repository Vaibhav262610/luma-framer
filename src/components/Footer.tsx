...
const Footer = () => {
  ...
  return (
    <>
      <div className="h-[90vh] border-t-2 border-zinc-800 gap-16 flex-col justify-center items-center w-full flex">
      ...
      <div className="flex md:flex-row flex-col justify-around pb-12 w-full">
