...
const CourseCategory = () => {
  ...
  return (
    <>
      <div className="md:h-[90vh] h-[150vh] w-full md:gap-12 gap-2 flex flex-col md:flex-row items-center justify-center ">
        ...
        <div className="grid grid-flow-col md:grid-cols-2 md:grid-rows-3 grid-cols-3 grid-rows-2 justify-center items-center gap-4 ">
          {data.map((val) => {
            return (
              <div
                key={val.id}
                className="border-[1px] text-white md:w-auto w-[16rem] bg-gradient-to-r from-white/5 to-black hover:from-white/10 duration-200 transition-all ease-in-out border-zinc-800 rounded-lg py-5 px-5 flex flex-col gap-2"
              >
