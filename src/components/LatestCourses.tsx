...
const LatestCourses = () => {
  ...
  return (
    <>
      <div className="h-screen md:h-fit w-full flex-col mt-10 gap-4 flex justify-center items-center">
        <div className="flex mt-24 items-start px-5 w-9/12 justify-between">
